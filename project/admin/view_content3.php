...
<section class="view-content">
   ...
   <?php
      $select_content = $conn->prepare("SELECT * FROM `content3` WHERE id = ? AND tutor_id = ?");
   ...
   <?php
      ...
      echo '<p class="empty">no contents added yet! <a href="add_content3.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
