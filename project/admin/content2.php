...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      ...
      <a href="add_content2.php" class="btn">add content</a>
   </div>

   <?php
      $select_videos = $conn->prepare("SELECT * FROM `content2` WHERE tutor_id = ? ORDER BY date DESC");
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content2.php?get_id=<?= $video_id; ?>" class="btn">view content</a>
      </div>
   <?php
         }
      }else{
